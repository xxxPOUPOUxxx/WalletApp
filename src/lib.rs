...
#[derive(Debug)]
pub struct WalletAppProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WalletAppProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WalletApp processing");
    
    let mut processor = WalletAppProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WalletAppProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WalletAppProcessor::new(false);
